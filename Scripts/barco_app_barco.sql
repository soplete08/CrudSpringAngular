...
CREATE TABLE `barco` (
  ...
  KEY `FKpakae8nos4t7i6klf60t3wuu` (`id_socio`),
  CONSTRAINT `FKpakae8nos4t7i6klf60t3wuu` FOREIGN KEY (`id_socio`) REFERENCES `socios` (`id`)
...
INSERT INTO `barco` VALUES ('123',0,0,'barco',3113),('7a',1,2,'stella',12);
